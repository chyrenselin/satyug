// ============================================================================
// Vishwa Samvidhan - Service Worker - v0.0
// Inspired by advanced caching strategies
// ============================================================================

const CACHE_NAME_STATIC = 'vishwa-samvidhan-static-v0.0'; // For app shell and core static assets
const CACHE_NAME_DYNAMIC = 'vishwa-samvidhan-dynamic-v0.0'; // For dynamic content and API responses (if any)
const CACHE_NAME_FONTS = 'vishwa-samvidhan-fonts-v0.0';   // For Google Fonts
...
const CORE_ASSETS_TO_CACHE = [
  ...
  'style.css',
  'script.js',
  '/satyug/assets/vishwa-samvidhan-anthem.mp3',
  '/satyug/assets/glogo.png',, // Assuming it's used and local
